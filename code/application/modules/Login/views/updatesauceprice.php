...
<form action="<?php echo base_url();?>updatesauceprice_submit" method="post">
Enter the sauce name:
<?php
$data=$this->db->select('name')->from('sauce')->where('status','added')->get()->result();
?>
<select name="name">
<?php
