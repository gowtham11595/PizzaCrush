...
<div class="col-sm-5">
<a href="<?php echo base_url();?>own_toppings_click/<?php print_r($value['name'])?>/<?php print_r($value['price'])?>/<?php print_r($value['category']);?>">
...
if(sizeof($result)!=0){            	
     ...
     <a href="<?php echo base_url();?>sauce_display" class="navbar-btn btn-success btn pull-right" style="  margin-left:30px;">
