...
<div class="col-sm-6" style="font-size: 80%;border-radius:25px; background: white;  border: 2px solid #8AC007;padding: 20px; width: 230px;height: 230px; margin-top: 10px;
    ...
    margin-left: 10px;">
<div class="pic"> 
<img src="<?php echo base_url();?>assets\uploadbread\<?php print_r($value['path']);?>"  class="img-thumbnail" style="height:90%;width:90%;cursor: pointer;">
</div>
...
<div class="col-sm-5">
<a href="<?php echo base_url();?>bread_click/<?php print_r($value['name'])?>/<?php print_r($value['price'])?>">
...
<div class="container" style="background: whitesmoke;">
<div class="row-fluid" >
<h4 style="color:green;">Medium</h4>
<?php 
foreach($data as $key=>$value)
{
	$value=(array)$value;
...
<div class="container" style="background: whitesmoke;margin-bottom:150px">
<div class="row-fluid" >
<h4 style="color:green;">Large</h4>
<?php 
foreach($data as $key=>$value)
{
	$value=(array)$value;
...
if(sizeof($result)!=0){            	
			foreach($result as $key=>$v)
			{
				$v=(array)$v;
		  ?>
		  <div class="col-sm-1" style="color:red;margin-left:20px;">
		  <?php
               if($v['type']=='bread')
               {
