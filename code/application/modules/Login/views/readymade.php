...
{
	$value=(array)$value;
    if($value['category']=='veg' && $value['size']=='small'){
...
<h5 style="background:white; color:lime; font-weight:bold;border-radius: 15px 50px 30px;">MEDIUM</h5>
<div class="row-fluid" >
<?php
foreach($data as $key=>$value)
{
	$value=(array)$value;
    if($value['category']=='veg' && $value['size']=='medium'){
...
<div class="col-sm-5">
<a href="<?php echo base_url();?>pizza_click/<?php print_r($value['name'])?>/<?php print_r($value['price'])?>/<?php print_r($value['category']);?>/<?php print_r($value['size']);?>">
<button type="button" class="btn btn-primary btn-round-xs btn-xs">select</button>
</a>
</div>
</div>
...
<div class="container" style="background: whitesmoke;">
<h5 style="background:white; color:lime; font-weight:bold;border-radius: 15px 50px 30px;">LARGE</h5>
<div class="row-fluid" >
<?php
foreach($data as $key=>$value)
{
	$value=(array)$value;
    if($value['category']=='veg' && $value['size']=='large'){
...
<div class="container" style="background: whitesmoke;">
<h5 style="background:white; color:red; font-weight:bold;border-radius: 15px 50px 30px;">SMALL</h5>
<div class="row-fluid" >
<?php
foreach($data as $key=>$value)
{
	$value=(array)$value;
    if($value['category']=='nonveg' && $value['size']=='small'){
...
<div class="container" style="background: whitesmoke;">
<h5 style="background:white; color:red; font-weight:bold;border-radius: 15px 50px 30px;">MEDIUM</h5>
<div class="row-fluid" >
<?php
foreach($data as $key=>$value)
{
	$value=(array)$value;
    if($value['category']=='nonveg' && $value['size']=='medium'){
...
<div class="container" style="background: whitesmoke;">
<h5 style="background:white; color:red; font-weight:bold;border-radius: 15px 50px 30px;">LARGE</h5>
<div class="row-fluid" >
<?php
foreach($data as $key=>$value)
{
	$value=(array)$value;
    if($value['category']=='nonveg' && $value['size']=='large'){
...
if(sizeof($result)!=0){            	
		  ...
		  <?php print_r($v['name']);?>
		  <div>
		  <a href="<?php echo base_url();?>delete_p/<?php print_r($v['id']);?>">
