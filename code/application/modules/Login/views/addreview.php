...
<div class="col-md-5">
    <div class="form-area">  
        <form role="form" action="<?php echo base_url();?>review_submit" method="post">
        <br style="clear:both">
                    <h3 style="margin-bottom: 25px; text-align: center;">Review Form</h3>
                    ...
                    <textarea class="form-control" type="textarea" id="review" name="review" placeholder="review" maxlength="300" rows="7"></textarea>
