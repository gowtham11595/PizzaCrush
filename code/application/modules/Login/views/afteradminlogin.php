...
<body style="background-image: url('https://www.wallpapersin4k.org/wp-content/uploads/2017/04/Pizza-Wallpaper-20.jpg'); border-radius:20px;padding-bottom:20px;">
<div class="container" >
<div class="row-fluid" >
...
<!--a href="<-php echo base_url();?>addreview"><button type="button" class="btn btn-success" hidden>ADD Review</button></a-->
</div>
...
<!--a href="<-?php echo base_url();?>deletereview"><button type="button" class="btn btn-danger"  hidden>Delete review</button></a-->
</div>
<div class="row-fluid" style="margin-top:50px;">
<h4 style="color:white;">
SHOW:
...
<a href="<?php echo base_url();?>show_orders"><button type="button" style="background-color: darkslategrey;
    ...
    font-size: 15px;
    margin: 2px 2px;
    cursor: pointer;" class="btn"  disabled>Show Orders</button></a>
</div>
</div>
</body>
</html>
